...
// proposta e in «Da controllare» in Home. In ROSSO vivo (#C0392B, lo stesso
...
export default function NotaCliente({ note, className = '', piccola = false }: { note: string | null | undefined; className?: string; piccola?: boolean }) {
  ...
  return (
    <p data-nota-cliente className={`${piccola ? 'text-[12.5px]' : 'text-sm'} leading-snug ${className}`} style={{ color: '#C0392B' }}>
