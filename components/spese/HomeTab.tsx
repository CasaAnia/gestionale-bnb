...
export default function HomeTab({
  ...
  return (
    <>
      ...
      <div className="ed-riga-ottone pb-4 mb-1 text-center">
      ...
      {caffeMese.tot > 0 && (
        <button onClick={() => apriDettaglio(`☕ I caffè di ${monthLabel(month)} · ${eur2(caffeMese.tot)}`, caffeMese.voci)}
          className="w-full ed-riga py-3 mb-3 text-left transition active:scale-[0.99]">
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        {tessere.map(t => (
          <button key={t.cat}
            ...
            className="ed-riga py-3 text-left transition active:scale-[0.98]">
