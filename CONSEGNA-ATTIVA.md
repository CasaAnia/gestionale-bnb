...
2. Migrazioni applicate a mano: 0001–0022, 0024, 0025, 0027, 0028, 0029, 0031. DA APPLICARE: 0032 (documenti dei clienti: tabella documenti_cliente + bucket privato «documenti», da creare prima in Storage). In `supabase/proposte` NON applicate: 0023, 0026 (RLS), 0030 (vincoli server fatture).
