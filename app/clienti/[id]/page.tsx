...
export default function ClienteDetail() {
  ...
  return (
    <div className="p-4">
      ...
      {showDelete && (
        <div className="fixed inset-0 ed-velo flex items-center justify-center z-50 p-4" onClick={() => setShowDelete(false)}>
          <div className="ed-foglio rounded-2xl p-4 w-full max-w-lg" onClick={e => e.stopPropagation()}>
