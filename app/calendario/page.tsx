    ...
    <div className="pb-24">
      ...
      {loading ? (
        ...
        <div className="overflow-x-auto">
          <table className="border-collapse w-full table-fixed" style={{ minWidth: `${60 + daysInMonth * 36}px` }}>
            <thead>
              <tr>
                ...
                {days.map(day => {
                  ...
                  return (
                    <th key={day} className={`text-center pb-1 border-b border-gray-100 ${isSun ? 'bg-gray-50/50' : ''}`} style={{ width: '32px', minWidth: '32px', maxWidth: '32px' }}>
