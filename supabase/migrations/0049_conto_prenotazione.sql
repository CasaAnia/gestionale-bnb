-- 0049 CONTO UNICO DELLA PRENOTAZIONE — applicata il 10 settembre 2026.
-- Con 0046/0047/0048, dopo backup verificato e collaudo concorrente su PostgreSQL 17.6.
-- Prova isolata: due backend simultanei, saldo 590 una sola volta.
-- Corpo SQL identico alla proposta collaudata.
begin;
do $$ begin
